...
This script is modified to train with an MRF input. We list the parameters that were modified to make this feasible.
...
path_generation_classes = '/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/Example_Data/numpy_arrays/generation_classes.npy'
prior_means='/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/scripts/tutorials/outputs_tutorial_6/estimated_priors_multi_modal/prior_means.npy'
prior_stds='/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/scripts/tutorials/outputs_tutorial_6/estimated_priors_multi_modal/prior_stds.npy'
...
# acquisition resolution parameters. No need to randomize resolution since it is known
randomise_res = False
