...
This is an extension to 3-training-mrf.py. We are testing on H17 combined 
...
path_images = '/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/scripts/tutorials/image_folder/multi_modal_mrf_val/MRF_H17.nii.gz'
# path to the output segmentation
path_segm = './outputs_tutorial_4_mrf/predicted_segmentations/im_seg.nii.gz'
# we can also provide paths for optional files containing the probability map for all predicted labels
path_posteriors = './outputs_tutorial_4_mrf/predicted_information/im_post.nii.gz'
...
path_segmentation_names = '/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/Example_Data/numpy_arrays/segmentation_names.npy'
...
path_resampled = './outputs_tutorial_4_mrf/predicted_information/im_resampled_target_res.nii.gz'
...
topology_classes = '/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/Example_Data/numpy_arrays/topology.npy'
...
gt_folder = '/local_mount/space/ladyyy/data/users/ashwink/python-codebases/SynthSeg/scripts/tutorials/image_folder/multi_modal_mrf_val_labels/MRF_H17.nii.gz'
